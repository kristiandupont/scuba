...
/**
 * The "inside" motion that selects what a given surround character encloses.
 * Both the opening and closing character map to the same motion, so `cs)"` and
 * `cs("` mean the same thing.
 */
export const surroundToMotionMap: Record<string, string> = {
  '"': 'i"',
  "'": "i'",
  "(": "i(",
  ")": "i(",
